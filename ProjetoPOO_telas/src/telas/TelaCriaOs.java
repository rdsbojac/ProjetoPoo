 ...
 * @author laris
 */
public class TelaCriaOs extends javax.swing.JFrame {

    /**
     * Creates new form TelaCriaOs
     */
    public TelaCriaOs() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCriaOs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCriaOs().setVisible(true);
            }
        });
    }
